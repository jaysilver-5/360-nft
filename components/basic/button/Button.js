import Link from 'next/link'; // Import 'next/link' instead of 'next/navigation'
    ...
    return (
      <Link href={href}>
        {isDropdownButton ? (
          ...
          <p href={href} className={`button-link`} style={{ textDecoration: 'none', marginRight: marginRight }}>
